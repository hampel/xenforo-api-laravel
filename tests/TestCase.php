...
abstract class TestCase extends BaseTestCase
{
    ...
    {
        return [XenForoServiceProvider::class];
    }
    ...
    {
        return ['XenForo' => XenForo::class];
    }

    protected function defineEnvironment($app): void
    {
        $app['config']->set('xenforo.default', 'main');
        $app['config']->set('xenforo.forums', [
            'main' => [
     ...
     *
     * Testbench declares $app as nullable because it does not exist before setUp, so every
     * use of it in a test is otherwise a call on Application|null.
     */
